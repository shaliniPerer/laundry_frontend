              ...
              {loading ? (
                ...
                <tr key={b.pk} className={`border-t border-slate-100 hover:bg-blue-50/30 ${i % 2 === 1 ? "bg-slate-50/40" : ""}`}>
                  ...
                  <td className="px-3 py-2">
                    <div ref={openActionId === b.pk ? actionMenuRef : null} className="relative inline-block">
                      <button type="button" onClick={(e) => { e.stopPropagation(); setOpenActionId(openActionId === b.pk ? null : b.pk); }} className="bg-teal-500 hover:bg-teal-600 text-white text-xs font-semibold px-3 py-1.5 rounded inline-flex items-center gap-1 transition-colors">
                      ...
                      {openActionId === b.pk && (
                        <div className="absolute right-0 top-full mt-0.5 bg-white border border-slate-200 rounded shadow-lg z-20 min-w-36 py-1">
                          ...
                          <button type="button" onClick={() => deleteBrand(b)} className="w-full text-left px-4 py-2 text-sm hover:bg-slate-50 text-red-600 flex items-center gap-2"><Trash2 className="w-3.5 h-3.5" /> Delete</button>
                        </div>
                      )}
                    </div>
                  </td>
